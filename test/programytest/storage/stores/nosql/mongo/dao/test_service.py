...
class ServiceTests(unittest.TestCase):
    ...
    def test_from_document_no_id(self):
        service1 = Service.from_document(
            {"name": "test", "service_class": "test.serviceclass"}
        )
    ...
    def test_from_document_with_id(self):
        service2 = Service.from_document(
            {"_id": "666", "name": "test", "service_class": "test.serviceclass"}
        )
    ...
    def test_from_document_no_id(self):
        ...
        self.assertEquals(
            "<Service(id='n/a', type='None', name='test', category='None', service_class='None'default_response='None', default_srai='None', default_aiml='None', load_default_aiml='True', success_prefix='None', url='None')>",
            str(service1),
        )
    ...
    def test_from_document_with_id(self):
        ...
        self.assertEquals(
            "<Service(id='666', type='None', name='test', category='None', service_class='None'default_response='None', default_srai='None', default_aiml='None', load_default_aiml='True', success_prefix='None', url='None')>",
            str(service2),
        )
