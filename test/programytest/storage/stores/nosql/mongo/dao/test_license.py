...
class LicenseKeyTests(unittest.TestCase):
    ...
    def test_init_with_id(self):
        ...
        self.assertEqual("key", license.key)
        self.assertEqual(
            {"_id": "666", "key": "key", "name": "name"}, license.to_document()
        )
    ...
    def test_repr_no_id(self):
        license1 = LicenseKey.from_document({"key": "key", "name": "name"})
        self.assertEquals(
            "<LicenseKey(id='n/a', name='name', key='key')>", str(license1)
        )
    ...
    def test_repr_id(self):
        ...
        self.assertEquals(
            "<LicenseKey(id='666', name='name', key='key')>", str(license2)
        )
