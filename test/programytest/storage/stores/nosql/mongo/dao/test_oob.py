...
class OOBTests(unittest.TestCase):
    ...
    def test_init_no_id(self):
        ...
        self.assertEqual(
            {"name": "test", "oob_class": "test.oobclass"}, oob.to_document()
        )
    ...
    def test_init_with_id(self):
        ...
        self.assertEqual("test.oobclass", oob.oob_class)
        self.assertEqual(
            {"_id": "666", "name": "test", "oob_class": "test.oobclass"},
            oob.to_document(),
        )
    ...
    def test_from_document_no_id(self):
        oob1 = OOB.from_document({"name": "test", "oob_class": "test.oobclass"})
        self.assertEquals(
            "<OOB(id='n/a', name='test', oob_class='test.oobclass')>", str(oob1)
        )
    ...
    def test_from_document_with_id(self):
        ...
        self.assertEquals(
            "<OOB(id='666', name='test', oob_class='test.oobclass')>", str(oob2)
        )
