...
class SetTests(unittest.TestCase):
    ...
    def test_init_no_id(self):
        ...
        self.assertEqual(
            {"values": ["val1", "val2", "val3"], "name": "TEST"}, aset.to_document()
        )
    ...
    def test_init_with_id(self):
        ...
        self.assertEqual(["val1", "val2", "val3"], aset.values)
        self.assertEqual(
            {"_id": "666", "values": ["val1", "val2", "val3"], "name": "TEST"},
            aset.to_document(),
        )
    ...
    def test_repr_no_id(self):
        aset1 = Set.from_document({"values": ["val1", "val2", "val3"], "name": "TEST"})
        self.assertEquals(
            "<Set(id='n/a', name='TEST', values='val1, val2, val3')>", str(aset1)
        )
    ...
    def test_repr_with_id(self):
        ...
        self.assertEquals(
            "<Set(id='666', name='TEST', values='val1, val2, val3')>", str(aset2)
        )
