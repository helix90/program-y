...
class TriggerTests(unittest.TestCase):
    ...
    def test_init_no_id(self):
        ...
        self.assertEqual(
            {"name": "test", "trigger_class": "test.triggerclass"},
            trigger.to_document(),
        )
    ...
    def test_init_with_id(self):
        ...
        self.assertEqual("test.triggerclass", trigger.trigger_class)
        self.assertEqual(
            {"_id": "666", "name": "test", "trigger_class": "test.triggerclass"},
            trigger.to_document(),
        )

    def test_from_document_no_id(self):
        trigger1 = Trigger.from_document(
            {"name": "test", "trigger_class": "test.triggerclass"}
        )
    ...
    def test_from_document_with_id(self):
        trigger2 = Trigger.from_document(
            {"_id": "666", "name": "test", "trigger_class": "test.triggerclass"}
        )
    ...
    def test_from_document_no_id(self):
        ...
        self.assertEquals(
            "<Trigger(id='n/a', name='test', trigger_class='test.triggerclass')>",
            str(trigger1),
        )
    ...
    def test_from_document_with_id(self):
        ...
        self.assertEquals(
            "<Trigger(id='666', name='test', trigger_class='test.triggerclass')>",
            str(trigger2),
        )
