...
from programytest.storage.asserts.store.assert_postquestionprocessors import (
    PostQuestionProcessorsStoreAsserts,
)
...
class SQLPostQuestionProcessorsStoreTests(PostQuestionProcessorsStoreAsserts):
    ...
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
    @patch(
        "programy.storage.stores.sql.store.processors.SQLProcessorsStore._load_processors_from_file",
