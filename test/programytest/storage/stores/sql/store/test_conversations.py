...
class SQLConversationStoreTests(ConverstionStoreAsserts):
    ...
    def test_read_write_conversation_properties_in_db(self):
        ...
        store._write_properties_to_db(
            client_context, 1, 2, ConversationPropertyDAO.CONVERSATION, properties1
        )
        ...
        store._read_properties_from_db(
            client_context, 1, 2, ConversationPropertyDAO.CONVERSATION, properties2
        )
    ...
    def test_read_write_question_properties_in_db(self):
        ...
        store._write_properties_to_db(
            client_context, 1, 2, ConversationPropertyDAO.QUESTION, properties1
        )
        ...
        store._read_properties_from_db(
            client_context, 1, 2, ConversationPropertyDAO.QUESTION, properties2
        )
    ...
    def test_read_write_matches_in_db(self):
        ...
        self.assertEqual(
            Match.WORD, matched_context2.matched_nodes[0].matched_node_type
        )
        self.assertEqual(
            "WORD [Hello]", matched_context2.matched_nodes[0].matched_node_str
        )
        ...
        self.assertEqual(
            ["Hello"], matched_context2.matched_nodes[0].matched_node_words
        )
    ...
    def test_questions_in_db(self):
        ...
        self.assertEqual(
            ["Hello", "There"], conversation2.questions[0].sentences[0].words
        )
    ...
    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_conversation_dao",
    ...
    def patch_get_question_dao(self, conversationid, question_no):
        return QuestionDAO(
            id=1, conversationid=conversationid, questionno=question_no, srai=False
        )

    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_question_dao",
        patch_get_question_dao,
    )
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
    ...
    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_sentence_dao",
        patch_get_sentence_dao,
    )
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
    ...
    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_match_dao",
        patch_get_match_dao,
    )
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
    ...
    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_matchnode_dao",
        patch_get_matchnode_dao,
    )
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
    ...
    def patch_get_property_dao(self, conversationid, questionid, proptype, name):
        return ConversationPropertyDAO(
            id=1,
    ...
    @patch(
        "programy.storage.stores.sql.store.conversations.SQLConversationStore._get_property_dao",
        patch_get_property_dao,
    )
    @unittest.skipIf(Engines.sql is False, Engines.sql_disabled)
