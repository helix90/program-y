...
class FileTriggersStoreTests(unittest.TestCase):
    ...
    def test_process_line(self):
        ...
        self.assertFalse(store._process_line("#", mgr))
        self.assertFalse(
            store._process_line("#TRIGGER1:programy.triggers.null.NullTrigger", mgr)
        )
    ...
    @patch(
        "programy.storage.stores.file.store.triggers.FileTriggersStore._load_triggers_from_file",
