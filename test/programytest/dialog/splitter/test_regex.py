...
class RegexSentenceSplitterTests(unittest.TestCase):
    ...
    def test_punctuation_at_end(self):
        ...
        self.assertEqual(
            ...
            splitter.split("Is this the first sentence?"),
        )
    ...
    def test_fullstop(self):
        ...
        self.assertEqual(
            ...
            splitter.split("This is the first sentence. This is the second"),
        )
    ...
    def test_question_mark(self):
        ...
        self.assertEqual(
            ["Is this the first sentence", "This is the second"],
            splitter.split("Is this the first sentence? This is the second"),
        )
