...
from programytest.security.linking.extension_asserts import (
    AccountLinkerExtensionAsserts,
)
...
class MockedAccountLinkerExtensionTests(AccountLinkerExtensionAsserts):
    ...
    @patch(
        "programy.security.linking.accountlinker.BasicAccountLinkerService.generate_link",
        patch_generate_link,
    )
