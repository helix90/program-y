...
class StarAIMLTests(unittest.TestCase):
    ...
    def test_multi_star_with_break(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "WELL HI2 THERE FRIEND"
        )
        self.assertIsNotNone(response)
    ...
    def test_multiple_stars_2(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "MULTIPLE STARS MATCH THIS THAT"
        )
        self.assertIsNotNone(response)
    ...
    def test_multiple_stars_4(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "MULTI STARS ONE TWO THREE FOUR"
        )
        self.assertIsNotNone(response)
    ...
    def test_stars_two_one(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "STARS FIRST ONE TWO SECOND THREE"
        )
        self.assertIsNotNone(response)
    ...
    def test_star_with_set(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "STAR WITH SET 666"
        )
        self.assertIsNotNone(response)
    ...
    def test_multi_stars_with_set(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "STAR WITH SETS 666 999"
        )
        self.assertIsNotNone(response)
    ...
    def test_mixed_stars_and_sets(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "MIXED STARS AND SETS 11 22 33 44 55"
        )
        self.assertIsNotNone(response)
    ...
    def test_recursion_one_star(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "RECURSIVE TEST"
        )
        self.assertIsNotNone(response)
    ...
    def test_recursion_two_stars(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "RECURSIVE TEST THIS"
        )
        self.assertIsNotNone(response)
    ...
    def test_recursion_four_stars(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "RECURSIVE TEST THIS THAT OTHER"
        )
        self.assertIsNotNone(response)
    ...
    def test_star_case(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "STAR CASE TEST1"
        )
        self.assertIsNotNone(response)
        self.assertEqual(response, "TEST1.")

        response = self._client_context.bot.ask_question(
            self._client_context, "STAR CASE test2"
        )
        self.assertIsNotNone(response)
        self.assertEqual(response, "Test2.")

        response = self._client_context.bot.ask_question(
            self._client_context, "STAR CASE TesT3"
        )
        self.assertIsNotNone(response)
