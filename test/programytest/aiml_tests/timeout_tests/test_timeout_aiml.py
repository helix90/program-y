...
class TimeoutAIMLTests(unittest.TestCase):
    ...
    def test_max_question_recursion_timeout(self):
        ...
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_question_recursion = 10
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_question_timeout = -1
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_search_depth = -1
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_search_timeout = -1
    ...
    def test_max_question_timeout_timeout(self):
        ...
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_question_recursion = -1
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_question_timeout = 0.1
        self._client_context.client.configuration.client_configuration.configurations[
            0
        ]._max_search_depth = -1
        self._client_context.client.configuration.client_configuration.configurations[
