...
class ThatSraiAIMLTests(unittest.TestCase):
    ...
    def test_that_srai_agreement(self):
        ...
        response = self._client_context.bot.ask_question(
            self._client_context, "GROUPAGREEMENT"
        )
        ...
        self.assertTrue(
            response
            in [
                "Hello. Do you know explore the website?",
                "Good day. Do you know explore the website?",
            ]
        )
    ...
    def test_that_srai_disagreement(self):
        ...
        response = self._client_context.bot.ask_question(
            self._client_context, "GROUPDISAGREEMENT"
        )
