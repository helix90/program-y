...
class PriorityAIMLTests(unittest.TestCase):
    ...
    def test_priority_solo(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "PRIORITY0"
        )
    ...
    def test_priority_first(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "PRIORITY1 TEST"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_first_multi(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "PRIORITY2 TEST1"
        )
        self.assertIsNotNone(response)
        self.assertEqual(response, "PRIORITY2 TEST1 SUCCESS.")

        response = self._client_context.bot.ask_question(
            self._client_context, "PRIORITY2 TEST2"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_middle(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS IS PRIORITY3 TEST"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_middle_multi(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS IS PRIORITY4 TEST1"
        )
        self.assertIsNotNone(response)
        self.assertEqual(response, "PRIORITY4 TEST1 SUCCESS.")

        response = self._client_context.bot.ask_question(
            self._client_context, "THIS IS PRIORITY4 TEST2"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_last(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS TEST IS PRIORITY5"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_last_multi(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS TEST1 IS PRIORITY6"
        )
        self.assertIsNotNone(response)
        self.assertEqual(response, "PRIORITY6 TEST1 SUCCESS.")

        response = self._client_context.bot.ask_question(
            self._client_context, "THIS TEST2 IS PRIORITY6"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_catch_all(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS IS NOY A TEST"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_not_a_test(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "THIS IS PRIORITY TEST"
        )
        self.assertIsNotNone(response)
    ...
    def test_priority_case(self):
        response = self._client_context.bot.ask_question(
            self._client_context, "HELLO FRIEND"
        )
        self.assertIsNotNone(response)
