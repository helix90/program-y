...
from programytest.services.rest.pandora.responses import (
    ask_service_failure,
    ask_success_response,
)
...
class PandoraServiceTests(ServiceTestCase):
    ...
    def test_handler_load_ask_success(self):
        ...
        response = self._do_handler_load(
            client, conf_file, "pandora", "PANDORA ASK HELLO"
        )
    ...
    @patch(
        "programy.services.rest.pandora.service.PandoraService.ask",
