...
from programytest.services.rest.gnews.responses import (
    search_success_response,
    top_news_success_response,
    topics_success_response,
)
...
class GNewsServiceTests(ServiceTestCase):
    ...
    @patch(
        ...
        patch_requests_get_search_success,
    )
    ...
    @patch(
        "programy.services.rest.base.RESTService._requests_get",
        patch_requests_get_top_news_success,
    )
    ...
    @patch(
        "programy.services.rest.base.RESTService._requests_get",
        patch_requests_get_topics_success,
    )
    ...
    def test_search_aiml(self):
        ...
        response = self._do_handler_load(
            client, conf_file, "gnews", "GNEWS SEARCH CHATBOTS"
        )
        self.assertIsNotNone(response)
        self.assertTrue(
            response.startswith(
                "<ul><li>Recovering Lost Sales with Facebook Messenger Marketing</li>"
            )
        )
    ...
    def test_topics_aiml(self):
        ...
        self.assertEqual(
            response,
            "<ul><li>world</li><li>nation</li><li>business</li><li>technology</li><li>entertainment</li><li>sports</li><li>science</li><li>health</li></ul>.",
        )
    ...
    def test_topic_aiml(self):
        ...
        response = self._do_handler_load(
            client, conf_file, "gnews", "GNEWS TOPIC TECHNOLOGY"
        )
        self.assertIsNotNone(response)
        self.assertEqual(
            response,
            """<ul><li>A triple folding phone? Hands-on with TCL's working DragonHinge prototype</li>
