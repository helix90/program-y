...
class RESTServiceTests(ServiceTestCase):
    ...
    def test_add_base_payload(self):
        ...
        service._add_base_payload(
            data, "success", "test", "http://some.service.com", "GET", 3, started, speed
        )
    ...
    def test_create_success_payload(self):
        ...
        started = datetime.now()
        speed = timedelta(microseconds=3000)
        data = service._create_success_payload(
            "test", "http://some.service.com", "GET", 3, started, speed, "response"
        )
    ...
    def test_create_statuscode_failure_payload(self):
        ...
        data = service._create_statuscode_failure_payload(
            "test", "http://some.service.com", "GET", 3, started, speed, mock_response
        )
    ...
    def test_create_http_failure_payload(self):
        ...
        started = datetime.now()
        speed = timedelta(microseconds=3000)
        data = service._create_http_failure_payload(
            "test",
    ...
    @patch(
        "programy.services.rest.base.RESTService._requests_get", patch_requests_get_fail
    )
    ...
    @patch(
        "programy.services.rest.base.RESTService._requests_post", patch_requests_post
    )
    ...
    @patch(
        "programy.services.rest.base.RESTService._requests_post",
        patch_requests_post_fail,
    )
