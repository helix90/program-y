...
class MicrosoftSearchServiceTests(ServiceTestCase):
    ...
    def test_init(self):
        service = MicrosoftSearchService(
    ...
    @unittest.skip(
        "Needs active cognitiveservices.azure.com account, chatilly closed down"
    )
    ...
    def test_search_aiml(self):
        ...
        response = self._do_handler_load(
            client, conf_file, "microsoft.search", "MICROSOFT SEARCH CHATBOTS"
        )
