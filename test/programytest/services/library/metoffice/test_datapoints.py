...
from programy.services.library.metoffice.metoffice import (
    DataPoint,
    MetOfficeWeatherReport,
)
...
class DataPointTest(unittest.TestCase):
    ...
    def test_extract_attribute(self):
        ...
        self.assertEqual(
            "value",
            dp.extract_attribute(
                {"item": "value"}, "item", MetOfficeWeatherReport.OBSERVATION
            ),
        )
        self.assertIsNone(
            dp.extract_attribute(
                {"item": "value"}, "itemx", MetOfficeWeatherReport.OBSERVATION, None
            )
        )
        ...
        self.assertEqual(
            ...
            dp.extract_attribute(
                {"item": "value"},
                "item",
                MetOfficeWeatherReport.FORECAST,
