...
class MetOffice24HourForecastServiceTests(ServiceTestCase):
    ...
    @patch(
        "programy.services.library.metoffice.metoffice.MetOffice.five_day_forecast",
        patch_metoffer_five_day_forecast_success,
    )
    ...
    @patch(
        "programy.services.library.metoffice.service.MetOfficeDaysForecastQuery._get_current_date",
    ...
    def test_handler_load_5_day_forecast(self):
        ...
        response = self._do_handler_load(
            ...
            conf_file,
            "metoffice",
            "METOFFICE FORECAST LAT SIGN POS DEC 56 FRAC 0719912 LNG SIGN NEG DEC 3 FRAC 1750909 DAYS 1",
        )
