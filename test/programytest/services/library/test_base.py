...
from programy.services.library.base import PythonAPIService, PythonAPIServiceException
...
class PythonAPIServiceTests(unittest.TestCase):
    ...
    def test_create_success_payload(self):
        ...
        data = service._create_success_payload(
            "search", started, speed, "search results"
        )
    ...
    def test_create_exception_failure_payload(self):
        ...
        started = datetime.now()
        speed = timedelta(microseconds=3000)
        data = service._create_exception_failure_payload(
            "search", started, speed, PythonAPIServiceException("Service failure")
        )
