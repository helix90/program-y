...
class PatternMatcherBotTests(PatternMatcherBaseClass):
    ...
    def test_basic_bot_match_as_text(self):
        ...
        self.add_pattern_to_graph(
            pattern="<bot>firstname</bot>", topic="X", that="Y", template="1"
        )
    ...
    def test_basic_bot_match_as_name(self):
        ...
        self.add_pattern_to_graph(
            pattern='<bot name="firstname" />', topic="X", that="Y", template="1"
        )
    ...
    def test_basic_bot_match_as_property(self):
        ...
        self.add_pattern_to_graph(
            pattern='<bot property="firstname" />', topic="X", that="Y", template="1"
        )
