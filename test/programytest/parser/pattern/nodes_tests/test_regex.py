...
class PatternRegexNodeTests(ParserTestsBaseClass):
    ...
    def test_to_xml_pattern(self):
        ...
        self.assertEqual(
            '<regex userid="*" pattern="^LEGION$"></regex>\n',
        ...
        self.assertEqual(
            '<regex userid="testid" pattern="^LEGION$"></regex>\n',
    ...
    def test_to_xml_template(self):
        ...
        self.assertEqual(
            '<regex userid="*" template="LEGION"></regex>\n',
            node1.to_xml(self._client_context, include_user=True),
        )
        ...
        self.assertEqual(
            '<regex userid="testid" template="LEGION"></regex>\n',
            node2.to_xml(self._client_context, include_user=True),
        )
    ...
    def test_to_string_pattern(self):
        ...
        self.assertEqual(
            ...
            "REGEX [testid] [P(0)^(0)#(0)C(0)_(0)*(0)To(0)Th(0)Te(0)] pattern=[^LEGION$]",
        )
    ...
    def test_to_string_template(self):
        ...
        self.assertEqual(
            node2.to_string(verbose=True),
            "REGEX [testid] [P(0)^(0)#(0)C(0)_(0)*(0)To(0)Th(0)Te(0)] template=[LEGION]",
        )
    ...
    def test_equals_pattern(self):
        ...
        match1 = node1.equals(
            self._client_context, Sentence(self._client_context, "LEGION"), 0
        )
