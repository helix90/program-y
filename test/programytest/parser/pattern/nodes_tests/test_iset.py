...
class PatternSetNodeTests(ParserTestsBaseClass):
    ...
    def test_to_xml(self):
        ...
        self.assertEqual(
            '<iset words="TEST1. TEST2. TEST3"></iset>\n',
        ...
        self.assertEqual(
            '<iset userid="testid" words="TEST1. TEST2. TEST3"></iset>\n',
    ...
    def test_to_string(self):
        node1 = PatternISetNode([], "test1, test2, test3")
        self.assertEqual(
            node1.to_string(verbose=False), "ISET words=[TEST1,TEST2,TEST3]"
        )
        self.assertEqual(
            node1.to_string(verbose=True),
            "ISET [*] [P(0)^(0)#(0)C(0)_(0)*(0)To(0)Th(0)Te(0)] words=[TEST1,TEST2,TEST3]",
        )

        node2 = PatternISetNode([], "test1, test2, test3", userid="testid")
        self.assertEqual(
            node2.to_string(verbose=False), "ISET words=[TEST1,TEST2,TEST3]"
        )
        self.assertEqual(
            node2.to_string(verbose=True),
            "ISET [testid] [P(0)^(0)#(0)C(0)_(0)*(0)To(0)Th(0)Te(0)] words=[TEST1,TEST2,TEST3]",
        )
    ...
    def test_equals(self):
        ...
        match1 = node1.equals(
            self._client_context, Sentence(self._client_context, "test1"), 0
        )
