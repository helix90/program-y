...
from programy.parser.template.nodes.select import Query, TemplateSelectNode
...
class TemplateSelectNodeTests(ParserTestsBaseClass):
    ...
    def test_init_with_queries_and_vars(self):
        ...
        self.assertEqual(
            "<select><vars>?subj ?pred</vars><q><subj>subj</subj><pred>pred</pred><obj>obj</obj></q></select>",
            root.to_xml(self._client_context),
        )
