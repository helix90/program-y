...
class TemplateLearnfNodeTests(ParserTestsBaseClass):
    ...
    def test_node(self):
        ...
        self._client_context.brain.configuration.defaults._learn_path = (
            self.get_os_specific_path()
        )
    ...
    def test_to_xml(self):
        ...
        self.assertEqual(
            "<template><learnf><category><pattern>HELLO LEARN</pattern><topic>*</topic><that>*</that><template>LEARN</template></category></learnf></template>",
            xml_str,
        )
