...
class TemplateCardNodeTests(ParserTestsBaseClass):
    ...
    def test_card_node(self):
        ...
        self.assertEqual(
            "<card><title>Servusai.com</title><subtitle>The home of ProgramY</subtitle><image>http://Servusai.com</image><button><text>More...</text><url>http://Servusai.com/aiml</url></button></card>",
            resolved,
        )
    ...
    def test_to_xml_no_subtitle_or_image(self):
        ...
        self.assertEquals(
            "<card><title>Servusai.com</title></card>",
            card.to_xml(self._client_context),
        )
