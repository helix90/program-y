...
class TemplateConditionType2NodeTests(ParserTestsBaseClass):
    ...
    def test_type2_node_global(self):
        ...
        ).current_question().set_property("cond1", "value2")
    ...
    @patch(
        "programy.parser.template.nodes.condition.TemplateConditionNode._resolve_type2_to_string",
        patch_resolve_type2_to_string,
    )
    ...
    def test_type2_to_xml_global(self):
        ...
        self.assertEqual(
            '<template><condition name="cond1"><li><value>value1</value>Word1</li> <li><value>value2</value>Word2</li> <li>Word3</li></condition></template>',
            xml_str,
        )
    ...
    def test_type2_node_local(self):
        ...
        node = TemplateConditionNode(
            "var1", var_type=TemplateConditionNode.LOCAL, condition_type=2
        )
        self.assertIsNotNone(node)
        cond1 = TemplateConditionListItemNode(
            value=TemplateWordNode("value1"), var_type=TemplateConditionNode.LOCAL
        )
        cond1.append(TemplateWordNode("Word1"))
        node.append(cond1)
        cond2 = TemplateConditionListItemNode(
            value=TemplateWordNode("value2"), var_type=TemplateConditionNode.LOCAL
        )
        cond2.append(TemplateWordNode("Word2"))
        node.append(cond2)
        cond3 = TemplateConditionListItemNode()
    ...
    def test_type2_node_bot(self):
        ...
        node = TemplateConditionNode(
            "cond1", var_type=TemplateConditionNode.BOT, condition_type=2
        )
        self.assertIsNotNone(node)
        cond1 = TemplateConditionListItemNode(
            value=TemplateWordNode("value1"), var_type=TemplateConditionNode.BOT
        )
        cond1.append(TemplateWordNode("Word1"))
        node.append(cond1)
        cond2 = TemplateConditionListItemNode(
            value=TemplateWordNode("value2"), var_type=TemplateConditionNode.BOT
        )
        cond2.append(TemplateWordNode("Word2"))
        node.append(cond2)
        cond3 = TemplateConditionListItemNode()
    ...
    def test_resolve_type2_condition(self):
        ...
        self.assertEquals(
            "Val5", template_node.resolve_type2_condition(self._client_context)
        )
    ...
    def test_resolve_type2_condition_no_default(self):
        ...
        template_node = ast.children[0]
        self.assertEquals(
            "", template_node.resolve_type2_condition(self._client_context)
        )
