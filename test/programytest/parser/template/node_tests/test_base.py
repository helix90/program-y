...
class TemplateNodeBasicTests(ParserTestsBaseClass):
    ...
    def test_node_children(self):
        ...
        self.assertEqual(
            "Word1 Word2", node.resolve_children_to_string(self._client_context)
        )
    ...
    def test_to_xml_composite(self):
        ...
        node.append(TemplateWordNode("Word2"))
        self.assertEqual(
            "Word1 <id /> <srai>Srai1</srai> Word2", node.to_xml(self._client_context)
        )
    ...
    def test_parse_template_node(self):
        ...
        node.parse_template_node(
            self._client_context.brain.aiml_parser.template_parser, pattern
        )
