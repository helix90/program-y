...
class TemplateUniqNodeTests(ParserTestsBaseClass):
    ...
    def test_match_only_vars(self):
        ...
        node = TemplateUniqNode(
            subj=TemplateWordNode("MONKEY"),
            pred=TemplateWordNode("LEGS"),
            obj=TemplateWordNode("?legs"),
        )
        result = TemplateUniqNode._match_only_vars(
            self._client_context, "MONKEY", "LEGS", "?z"
        )
