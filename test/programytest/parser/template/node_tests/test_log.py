...
class TemplateLogNodeTests(ParserTestsBaseClass):
    ...
    def test_to_xml_default(self):
        ...
        self.assertEqual(
            '<template><log level="debug">Log Test</log></template>', xml_str
        )
    ...
    def test_to_xml_error(self):
        ...
        xml_str = ET.tostring(xml, "utf-8").decode("utf-8")
        self.assertEqual(
            '<template><log level="error">Log Test</log></template>', xml_str
        )
    ...
    def test_to_xml_warning(self):
        ...
        xml_str = ET.tostring(xml, "utf-8").decode("utf-8")
        self.assertEqual(
            '<template><log level="warning">Log Test</log></template>', xml_str
        )
