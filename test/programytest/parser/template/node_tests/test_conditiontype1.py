...
class TemplateConditionType1NodeTests(ParserTestsBaseClass):
    ...
    def test_type1_node_global_match(self):
        ...
        node = TemplateConditionNode(
            "name1", TemplateWordNode("value1"), var_type=TemplateConditionNode.GLOBAL
        )
        ...
        self._client_context.bot.get_conversation(self._client_context).set_property(
            "name1", "value1"
        )
    ...
    @patch(
        "programy.parser.template.nodes.condition.TemplateConditionNode._resolve_type1_to_string",
        patch_resolve_type1_to_string,
    )
    ...
    def test_type1_to_xml_global(self):
        ...
        self.assertEqual(
            '<template><condition name="name1"><value>value1</value>Hello</condition></template>',
            xml_str,
        )
    ...
    def test_type1_node_local_match(self):
        ...
        node = TemplateConditionNode(
            "var1", TemplateWordNode("value1"), var_type=TemplateConditionNode.LOCAL
        )
        self.assertIsNotNone(node)
        ...
        self._client_context.bot.get_conversation(self._client_context).record_dialog(
            question
        )
        self._client_context.bot.get_conversation(
            self._client_context
        ).current_question().set_property("var1", "value1")
    ...
    def test_type1_node_local_nomatch(self):
        ...
        self._client_context.bot.get_conversation(
            self._client_context
        ).current_question().set_property("var1", "value2")
    ...
    def test_type1_to_xml_local(self):
        root = TemplateNode()
        node = TemplateConditionNode(
            "name1", TemplateWordNode("value1"), var_type=TemplateConditionNode.LOCAL
        )
        node.append(TemplateWordNode("Hello"))
        root.append(node)
        ...
        xml_str = ET.tostring(xml, "utf-8").decode("utf-8")
        self.assertEqual(
            '<template><condition var="name1"><value>value1</value>Hello</condition></template>',
            xml_str,
        )
    ...
    def test_type1_node_bot_match(self):
        ...
        node = TemplateConditionNode(
            "name1", TemplateWordNode("value1"), var_type=TemplateConditionNode.BOT
        )
        self.assertIsNotNone(node)
    ...
    def test_to_string_defaults_global(self):
        node = TemplateConditionNode(
            name="global", var_type=TemplateConditionVariable.GLOBAL
        )
        self.assertEquals('[CONDITION name="global"]', node.to_string())

    def test_to_string_defaults_local(self):
        node = TemplateConditionNode(
            name="local", var_type=TemplateConditionVariable.LOCAL
        )
    ...
    def test_to_xml_with_value(self):
        ...
        self.assertEquals(
            "<condition><value>3</value></condition>", node.to_xml(self._client_context)
        )
    ...
    def test_to_xml_defaults_global(self):
        ...
        self.assertEquals(
            '<condition name="global"></condition>', node.to_xml(self._client_context)
        )
    ...
    def test_to_xml_defaults_local(self):
        ...
        self.assertEquals(
            '<condition var="local"></condition>', node.to_xml(self._client_context)
        )

    def test_to_xml_defaults_bot(self):
        node = TemplateConditionNode(name="bot", var_type=TemplateConditionVariable.BOT)
        self.assertEquals(
            '<condition bot="bot"></condition>', node.to_xml(self._client_context)
        )
    ...
    def test_resolve_block(self):
        node = TemplateConditionNode(
            name="global", value="3", condition_type=TemplateConditionNode.BLOCK
        )
        self.assertEquals("", node.resolve_to_string(self._client_context))

    def test_resolve_single(self):
        node = TemplateConditionNode(
            name="global", value="3", condition_type=TemplateConditionNode.SINGLE
        )
        self.assertEquals("", node.resolve_to_string(self._client_context))

    def test_resolve_bot(self):
        node = TemplateConditionNode(
            name="global", value="3", condition_type=TemplateConditionNode.BOT
        )
        self.assertEquals("", node.resolve_to_string(self._client_context))
