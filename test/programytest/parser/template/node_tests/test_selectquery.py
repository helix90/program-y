...
from programy.parser.template.nodes.select import NotQuery, Query, QueryBase
...
class TemplateSelectQueryTests(ParserTestsBaseClass):
    ...
    def test_querybase(self):
        ...
        query = QueryBase(
            TemplateWordNode("subj"), TemplateWordNode("pred"), TemplateWordNode("obj")
        )
        ...
        self.assertEqual(
            "<subj>subj</subj><pred>pred</pred><obj>obj</obj>",
            query.to_xml(self._client_context),
        )
    ...
    def test_query_no_tuples(self):
        query = MockQuery(
            TemplateWordNode("subj"),
            TemplateWordNode("pred"),
    ...
    def test_query_one_tuple(self):
        ...
        self.assertEqual(
            [[["subj", "a"], ["pred", "b"], ["obj", "c"]]],
            query.execute(self._client_context),
        )
    ...
    def test_notquery(self):
        ...
        self.assertEqual(
            "<notq><subj>subj</subj><pred>pred</pred><obj>obj</obj></notq>",
            query.to_xml(self._client_context),
        )
