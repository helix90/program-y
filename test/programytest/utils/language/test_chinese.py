...
class ChineseTests(unittest.TestCase):
    ...
    def test_split_langauge(self):
        ...
        self.assertEqual(
            ["X", "你", "好", "Y"], ChineseLanguage.split_language("X你好Y")
        )
    ...
    def test_split_unicode(self):
        ...
        self.assertEqual(
            ["X", "你", "好", "Y"], ChineseLanguage.split_unicode("X你好Y")
        )
    ...
    def test_split_with_spaces(self):
        ...
        self.assertEqual(
            "X  你  好", ChineseLanguage.split_with_spaces(["X", "你", "好"])
        )
        self.assertEqual(
            "X  你  好  Y", ChineseLanguage.split_with_spaces(["X", "你", "好", "Y"])
        )
        self.assertEqual(
