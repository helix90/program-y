...
class PostProcessingTests(unittest.TestCase):
    ...
    def test_load(self):
        ...
        file_store_config._postprocessors_storage = FileStoreConfiguration(
        ...
        storage_factory._store_to_engine_map[StorageFactory.POSTPROCESSORS] = (
            storage_engine
        )
    ...
    def post_process(self, output_str):
        ...
        context.bot.brain.denormals.add_to_lookup(
            " ATSIGN ", [re.compile("(^ATSIGN | ATSIGN | ATSIGN$)", re.IGNORECASE), "@"]
        )
