...
class DenormaliseTests(unittest.TestCase):
    ...
    def test_collection_operations(self):
        ...
        self.assertEqual(
            [re.compile("(^DOT COM | DOT COM | DOT COM$)", re.IGNORECASE), ".com"],
            collection.value(" DOT COM "),
        )

        self.assertEqual(
            collection.denormalise_string("keithsterling dot com"), "keithsterling.com"
        )
    ...
    @patch(
        "programy.mappings.denormal.DenormalCollection._load_collection",
